...
public class GRPC_Client {
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case 5:
                    ...
                    return;
                default:
                    System.out.println("Not a valid input, try with valid one.");
            }
        }
    }
    ...
    public static void displayMenu() {
        ...
        System.out.println("1. Sign Up as an user !: ");
        System.out.println("2. Sign In With UserName and Password");
        System.out.println("3. Create a Profile for More info");
        System.out.println("4. Update your Profile ");
        System.out.println("5. See  your Profile ");
        System.out.println("6. Log Out from the system");
        System.out.print("Select the number  that you want to do :");
    }

    private static void registerUser(userGrpc.userBlockingStub userBlockingStub, Scanner scanner) {
        System.out.print("Enter Your User Name to Register: ");
        String username = scanner.nextLine();
        System.out.print("Your Password (should be unique): ");
    ...
    private static void login(userGrpc.userBlockingStub userBlockingStub, Scanner scanner) {
        System.out.print("Enter the username that Was registerd with: ");
        String username = scanner.nextLine();
    ...
    private static void createProfile(userGrpc.userStub userStub, Scanner scanner) {
        ...
        System.out.print("Enter your valid email addresss: ");
        ...
        StreamObserver<User.ProfileResponse> responseObserver = new StreamObserver<User.ProfileResponse>() {
            ...
            public void onCompleted() {
                logger.info("Successfully created the profile");
            }
        };
    ...
    private static void updateProfile(userGrpc.userStub userStub, Scanner scanner) {
        System.out.print("Enter the Registered  username: ");
        String username = scanner.nextLine();
        System.out.print("Enter your updated full name to update your name: ");
        String fullName = scanner.nextLine();
        System.out.print("Enter you new email to replace with: ");
        String email = scanner.nextLine();
        ...
        StreamObserver<User.ProfileResponse> responseObserver = new StreamObserver<User.ProfileResponse>() {
            ...
            @Override
            public void onCompleted() {
                logger.info("Successfully updated the Profile ");
            }
        };
